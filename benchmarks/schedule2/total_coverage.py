...
def base_coverage():
    ...
    with open('json/schedule2.json', 'r') as file:
    ...
    with open('json/base_coverage_total_schedule2.json', 'w') as outfile:
...
def test_suite_generation(coverage):
    ...
    with open('json/base_coverage_total_schedule2.json','r') as file:
...
def main():
    ...
    for input_file in input_files:
        ...
        if args.s:
            ...
            delete_file()
            with open('json/schedule2.json', 'w') as file:
